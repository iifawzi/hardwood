...
/// Common interface for name-based field access, shared by both top-level row readers
/// and nested struct values.
///
/// This interface makes no assumptions about mutability or lifecycle, allowing code to
/// work polymorphically with both [dev.hardwood.reader.RowReader] (a stateful,
/// mutable view over the current row) and [PqStruct] (an immutable, self-contained
/// nested struct value).
///
/// @see PqStruct
